            ...
            <View style={{flex: 1, marginTop: "45%", justifyContent: 'space-between'}}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center'}}>
                    <TextInput
                        ...
                        placeholder='00'
                        style={{ color: `${theme}`,fontFamily:"Poppins-Bold",
                                    fontSize: 70, textAlign: 'center' }}
                    />
                    <Text style={{ color: `${theme}`, fontSize: 70}}>
                        :
                    </Text>
                    <TextInput
                        selectTextOnFocus={true}
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-around', marginBottom: "15%"}}>
                    <TouchableOpacity onPress={resetTimer}
                                    style={[styles.stopwatchBtn, {borderColor: `${theme}`,backgroundColor:`${theme}20`}]}>
                        <Text style={{fontSize: 20, color: `${theme}`,width:"50%",fontFamily:"Poppins-Bold"}}>Reset</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={toggleTimer}
                                    style={[styles.stopwatchBtn, 
                                            {borderColor: `${theme}`, 
                                            backgroundColor: timerRunning ? `${theme}` : `${theme}20`}]}>
                        <Text style={{fontSize: 20, color: timerRunning ? "#ffffff" : `${theme}`,width:"50%",fontFamily:"Poppins-Bold"}}>
            ...
            <View style={{flex: 1, marginTop: "45%", justifyContent: 'space-between'}}>
                ...
                <View>
                    <Text style={{ color: `${theme}`,
                                    fontSize: 70, textAlign: 'center',fontFamily:"Poppins-Bold" }}>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-around', marginBottom: "15%"}}>
                    ...
                    <TouchableOpacity onPress={toggleStopwatch}
                                    style={[styles.stopwatchBtn, 
                                            {borderColor: `${theme}`, 
                                            backgroundColor: stopwatchRunning ? `${theme}` : `${theme}20`}]}>
                        <Text style={{fontSize: 20, color: stopwatchRunning ? "#ffffff" : `${theme}`,width:"50%",fontFamily:"Poppins-Bold"}}>
            ...
            <View style={[styles.container, {marginBottom: tabBarHeight+25}]}>
                <View style={{flexDirection: 'row', justifyContent: 'center', marginTop: "8%"}}>
                    <TouchableOpacity onPress={() => {setMode("Timer")}}
                        ...
                        <Text style={{fontSize: 20, color: mode == 'Timer' ? "#ffffff" : `${theme}`,fontFamily:"Poppins-Bold"}}>
                            Timer
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {setMode("Stopwatch")}}
                        ...
                        <Text style={{fontSize: 20, color: mode == 'Stopwatch' ? "#ffffff" : `${theme}`,width:"80%",fontFamily:"Poppins-Bold"}}>
                            Stopwatch
                        </Text>
                    </TouchableOpacity>
                </View>

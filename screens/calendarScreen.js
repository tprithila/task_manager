...
const CalendarScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        ...
        const day = {
            dateString: todayDate_formatted, day: todayDate.getDate(),
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: TintCol() }]}>
            <View style={{ flex: 1, marginTop: "10%", marginBottom: tabBarHeight + 25 }}>
                <Agenda
                    ...
                    theme={{
                        ...
                        agendaDayFontFamily: "Poppins-Regular",
                        agendaDayNumFontFamily: "Poppins-Regular",
                        agendaTodayFontFamily: "Poppins-Regular",
                    }}
                />
            </View>
        </SafeAreaView>

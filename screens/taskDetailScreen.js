                    ...
                    <View style={styles.overlayContainer}>
                        <View style={[styles.imageOverlay, { backgroundColor: darkmode ? "#000000" : "#ffffff", borderColor: `${theme}` }]}>
                            ...
                            <TouchableOpacity style={styles.closeModalBtn} onPress={() => { setImageModal(!imageModal) }}>
                                <MaterialCommunityIcons name="close-circle" size={32} color={`${theme}`} />
                            </TouchableOpacity>
                            {/* PREVIEW IMAGE MODAL */}
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                    {/* IMAGE FILE NAME */}
                                    <Text style={{ fontSize: 16, alignSelf: 'center', marginLeft: "5%", color: darkmode ? "#ffffff" : "#000000",fontFamily:"Poppins-Regular" }}>
                                        {/* {currentImageFN} */}
                                    ...
                                    <View style={{ flexDirection: 'row', alignItems: 'flex-end' }}>
                                        ...
                                        <TouchableOpacity style={styles.downloadFileBtn} onPress={() => { shareImageOrFile(currentImage) }}>
                                            <MaterialCommunityIcons name="share" size={22} color={`${theme}`} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
        ...
        return (
            <View>
                ...
                <TouchableOpacity onPress={() => previewFile(data.index)}
                    style={styles.imageListCoverContainer}>
                    <Text style={[styles.fileListCover, { borderColor: `${theme}`, color: darkmode ? "#ffffff" : "#000000",fontFamily:"Poppins-Regular" }]}>{data.item.name}</Text>
                </TouchableOpacity>
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: TintCol() }]}>
            <View style={[styles.taskContainer, { marginBottom: tabBarHeight + 25 }]}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{
                        flex: 1, flexDirection: 'row', borderBottomWidth: 0, alignItems: 'center', justifyContent: 'space-between',
                        borderBottomColor:
                            taskItemForScreen.priority == "High" ? "crimson" :
                                taskItemForScreen.priority == "Medium" ? "gold" :
                                    taskItemForScreen.priority == "Low" ? "forestgreen" :
                        ...
                        borderWidth:
                            0,
                        backgroundColor:
                            taskItemForScreen.priority == "High" ? "#DC143C20" :
                                taskItemForScreen.priority == "Medium" ? "#FFD70020" :
                                    taskItemForScreen.priority == "Low" ? "#228B2220" : `${theme}40`,
                        paddingLeft: 6,
                                    ...
                                    taskItemForScreen.complete ? "darkgrey" :
                                        taskItemForScreen.priority == "High" ? "crimson" :
                                            taskItemForScreen.priority == "Medium" ? "gold" :
                                                taskItemForScreen.priority == "Low" ? "forestgreen" :
                                                    `${theme}`,
                                textDecorationLine: taskItemForScreen.complete ? 'line-through' : 'none', fontFamily: "Poppins-Bold"
                            }}>
                ...
                <View style={{ marginVertical: "3%" }}>
                    <ScrollView horizontal={true}>
                        ...
                        <View style={[styles.taskDateContainer,
                        {
                            ...
                            <Text style={[styles.taskText, { color: `${theme}`, fontFamily: "Poppins-Regular" }]}>
                ...
                <View style={{ flex: 1 }}>
                    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                        {/* TASK SUBTASKS */}
                        <View style={{ borderBottomWidth: 0, borderColor: `${theme}`, marginBottom: "5%", backgroundColor: `${theme}50`, paddingHorizontal: 8, paddingVertical: 8 }}>
                            <Text style={{ fontSize: 20, color: `${theme}`, fontFamily: "Poppins-Regular" }}>
                                Subtasks
                            </Text>
                        </View>
                        {taskItemForScreen.subtask.length == 0 ?
                            (
                                <Text style={{ fontSize: 16, color: darkmode ? "#ffffff" : "#000000",fontFamily:"Poppins-Regular",marginLeft:2 }}>
                                    No subtasks
                                </Text>
                            ) : (
                                taskItemForScreen.subtask.map((subtaskItem, key) => {
                                    return (
                                        <View style={{ flexDirection: 'row', alignItems: 'center', }} key={key}>
                                            ...
                                            />
                                            <Text style={[styles.taskText, { color: darkmode ? "white" : "#000000",fontFamily:"Poppins-Regular" }]}>
                                                {subtaskItem.subtask}
                                            </Text>
                                        </View>
                                    )

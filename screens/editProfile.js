    ...
    return (
        <SafeAreaView style={[styles.container, {backgroundColor: darkmode ? "#000000" : "#ffffff"}]}>
            <ScrollView style={{marginTop: "8%", marginHorizontal: "5%",}}>
                ...
                <View style={[styles.inputContainer, { borderColor: `${theme}` }]}>
                    <FontAwesome name="user" size={30} color={`${theme}`}  style={{ marginRight: '2%',marginLeft:"2%" }}/>
                    <TextInput
                ...
                <View style={[styles.inputContainer, { borderColor: `${theme}` }]}>
                    <MaterialCommunityIcons name="email" size={30} color={`${theme}`}  style={{ marginRight: '2%',marginLeft:"2%" }}/>
                    <TextInput
                        placeholder='Email'
                        value={email}
                ...
                <View style={[styles.inputContainer, { paddingVertical: 11,borderColor: `${theme}` }]}>
                    <MaterialCommunityIcons name="calendar" size={30} color={`${theme}`}  style={{ marginRight: '2%',marginLeft:"2%" }}/>
                        ...
                        (
                            <View>
                                <TouchableOpacity style={[styles.dateText, {borderColor: `${theme}`}]}
                                    ...
                                    <Text style={{fontSize: 14, color: `${theme}`,fontFamily:"Poppins-Regular"}}>{dob.toDateString()}</Text>
                                </TouchableOpacity>
                ...
                <View style={[styles.inputContainer, { borderColor: `${theme}` }]}>
                    <MaterialCommunityIcons name="lock" size={30} color={`${theme}`} style={{ marginRight: '2%',marginLeft:"2%" }}/>
                    <TextInput
                ...
                <View>
                    <TouchableOpacity onPress={toggleDeleteUserProfile}
                        ...
                        <Text style={{fontSize: 16, color: 'crimson',fontFamily:"Poppins-Bold"}}>Delete Account</Text>
                    </TouchableOpacity>
                </View>
                    ...
                    <View style={styles.overlayContainer}>
                        <View style={[styles.imageOverlay, {backgroundColor: darkmode ? "#000000":"#ffffff", borderColor: `${theme}`}]}>
                            ...
                            <View style={{flex: 1, marginHorizontal: "5%"}}>
                                <Text style={{fontSize: 18, marginBottom: "15%", color: darkmode ? "#ffffff":"#000000",fontFamily:"Poppins-Bold"}}>
                                    Enter login information to delete account
                                </Text>
                                {/* EMAIL */}
                                <Text style={[styles.inputLabel, {color: `${theme}`,fontFamily:"Poppins-Bold"}]}>Email:</Text>
                                <View style={[styles.inputContainer, { borderColor: `${theme}` }]}>
                                    <MaterialCommunityIcons name="email" size={30} color={`${theme}`} style={{marginRight: "2%",marginLeft: "2%"}}/>
                                    <TextInput
                                        placeholder='Email'
                                ...
                                {/* PASSWORD */}
                                <Text style={[styles.inputLabel, {color: `${theme}`,fontFamily:"Poppins-Bold"}]}>Password:</Text>
                                <View style={[styles.inputContainer, { borderColor: `${theme}` }]}>
                                    <MaterialCommunityIcons name="lock" size={30} color={`${theme}`}  style={{marginRight: "2%",marginLeft: "2%"}}/>
                                    <TextInput
                                        placeholder='Password'

    ...
    const attachmentOptionsItem = ({ item }) => {
        return (
            <TouchableOpacity onPress={item.onPress}
                ...
                {item.icon}
                <Text style={[styles.optionText, { color: darkmode ? "#ffffff" : "#000000", width: "100%" }]}>{item.option}</Text>
            </TouchableOpacity>
        );
    }
        ...
        <View style={{ marginTop: "1%", marginBottom: "2%", borderWidth: 2, borderColor: `${theme}`, padding: 8, borderRadius: 0 }}>
            ...
            <View style={styles.attachmentHeader}>
                ...
                <View style={styles.attachmentBtnContainer}>
                    {/* ATTACH FILE BUTTON */}
                    <View style={[styles.attachmentBtnContainer,{backgroundColor:darkmode?"#FFFFFF":`${theme}40`}]}>
                        <TouchableOpacity
                            onPress={() => setAttachmentModal(!attachmentModal)}
                            style={styles.attachmentButton}
                        >
                            <Text style={[styles.attachmentLabel, { color: BackgroundCol(), marginRight: 8 }]}>
                                Attachment Image or File
                            </Text>
                            <MaterialIcons name="attachment" size={24} color={BackgroundCol()} />
                        </TouchableOpacity>
                    </View>
            ...
            {imageList.length > 0 ? (
                <View>
                    <Text style={{ fontSize: 16, textDecorationLine: 'underline', color: darkmode ? "#ffffff" : "#000000", fontFamily: 'Poppins-Medium' }}>
                        Images:
                    </Text>
                    <FlatList
                        horizontal={true}
                ...
                <Text style={{ color: darkmode ? "#ffffff" : "#000000", fontFamily: 'Poppins-Medium' }}>No image uploaded</Text>
            )
            }
            ...
            {fileList.length > 0 ? (
                ...
                <Text style={{ color: darkmode ? "#ffffff" : "#000000", fontFamily: 'Poppins-Medium' }}>No file uploaded</Text>
            )
            }
        </View>
    );
